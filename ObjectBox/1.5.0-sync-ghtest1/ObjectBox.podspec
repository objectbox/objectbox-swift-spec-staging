Pod::Spec.new do |spec|
  spec.name         = 'ObjectBox'
  spec.version      = '1.5.0-sync-ghtest1'
  ...
  spec.source = {
    :http => 'https://github.com/objectbox/objectbox-swift-spec-staging/releases/download/v1.x/ObjectBox-xcframework-1.5.0-sync-ghtest1.zip'
  }

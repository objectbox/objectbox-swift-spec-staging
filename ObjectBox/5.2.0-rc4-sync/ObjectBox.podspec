Pod::Spec.new do |spec|
  ...
  spec.source = {
    :http => 'https://github.com/objectbox/objectbox-swift-spec-staging/releases/download/5-preview/ObjectBox-xcframework-5.2.0-rc4-sync.zip'
  }

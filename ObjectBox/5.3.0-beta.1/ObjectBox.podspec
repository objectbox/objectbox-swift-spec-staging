Pod::Spec.new do |spec|
  ...
  spec.source = {
    :http => 'https://github.com/objectbox/objectbox-swift-spec-staging/releases/download/5-preview/ObjectBox-xcframework-5.3.0-beta.1.zip'
  }
